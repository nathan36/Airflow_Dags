...
class parser():
    def __init__(self, areas:list, type, max_price, min_year_built):
        self.areas = areas
        self.type = type
        ...
        if self.areas:
            for area in self.areas:
                ...
                if response.status_code != requests.codes.ok:
                    self.area_list_with_error.append(area)
                    status_flag = 'error'

        self.response_status = status_flag
